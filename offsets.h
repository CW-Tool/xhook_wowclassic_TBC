...
namespace Offsets
{
	...
	static inline uintptr_t FaceTo = Base + 0x143EEB0;
	...
	static inline uintptr_t CGItem_UseItem = Base + 0x443950; 
	...
	static inline uintptr_t GetWorld = Base + 0x1F1D40; //read memory method  Read QWORD (Base + 0x2D01290)
